...
include $(CLEAR_VARS)
LOCAL_MODULE := MaxxAudioFX
LOCAL_SRC_FILES := proprietary/priv-app/MaxxAudioFX/MaxxAudioFX.apk
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
LOCAL_MODULE_CLASS := APPS
...
include $(CLEAR_VARS)
LOCAL_MODULE := libMA3-processcode-Coretex_A9
LOCAL_SRC_FILES := proprietary/vendor/lib/libMA3-processcode-Coretex_A9.so
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(TARGET_OUT_VENDOR_SHARED_LIBRARIES)
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
...
include $(CLEAR_VARS)
LOCAL_MODULE := libMA3-processcode-Qualcomm
LOCAL_SRC_FILES := proprietary/vendor/lib/libMA3-processcode-Qualcomm.so
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(TARGET_OUT_VENDOR_SHARED_LIBRARIES)
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
